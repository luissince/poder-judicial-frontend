...
const FormularioView = (props: RouteComponentProps<{}>) => {
    ...
    const handleButtonClick = async () => {
        ...
        // window.open("http://localhost:8080/pdf");
        // return
        ...
        <div className="isolate bg-white px-6 py-0 sm:py-1 lg:px-8">
            <CustomModal
                ...
                onOpen={async () => {
                    ...
                    if (response instanceof Response<Blob>) {
                ...
                onClose={handleClose}>
                <button className="absolute top-2 right-2 p-2 z-[100] rounded-full bg-gray-200 hover:bg-gray-300 text-gray-800" onClick={handleClose}>
                ...
                <div className="flex items-center justify-center w-full h-full">
                    <div className="w-full p-10">
                        <embed ref={embedRef} className="w-full h-[800px]" type="application/pdf"  />
                    </div>
                </div>
            </CustomModal>
                    ...
                    <div className="sm:col-span-2">
                        <div className="mt-0">
                            <select
                                ...
                                <option value="4. ¿Lo reportado ha sido validado por implantación?">4. ¿Lo reportado ha sido validado por implantación? </option>
                                <option value="5. ¿Se está utilizando la última versión de la aplicación desplegada en la corte?">5. ¿Se está utilizando la última versión de la aplicación desplegada en la corte? </option>
                            </select>
                        </div>
                    </div>
                </div>
